...
import com.itarocha.starweb.repository.PlanetaCasaRepository;


@Controller
@RequestMapping("planetacasa")
public class PlanetasCasasController {
	
	private static final String PAGINA = "planetacasa";
	private static final String PAGINA_INDEX = "planetacasa/index";
	private static final String PAGINA_EDIT = "planetacasa/edit";
	private static final String PAGINA_CONSULTAS = "planetacasa/index";
	//private static final String PAGINA_REDIRECT = "redirect:/clientes";
	private static final String PAGINA_REDIRECT = "redirect:/planetacasa";
	private static final String NOME_CLASSE = "PlanetaCasa";
	
	
	@Autowired
	private PlanetaCasaRepository service;
	...
	*/
	...
	public ModelAndView all()
	{
		...
		List<PlanetaCasa> lista = service.findAllOrderByPlanetaAndCasa();
	...
	*/
	...
	public ModelAndView novo(){
		...
		PlanetaCasa model = new PlanetaCasa();
		mv.addObject("model", model);
		return mv;
	}
	
	@RequestMapping("/edit/{id}")
	public ModelAndView editar(@PathVariable("id") PlanetaCasa model){
		ModelAndView mv = new ModelAndView(PAGINA_EDIT);
		mv.addObject("model", model);
		return mv;
	}
	...
	@PostMapping()
	public String salvar(	@Valid @ModelAttribute("model") PlanetaCasa model, 
