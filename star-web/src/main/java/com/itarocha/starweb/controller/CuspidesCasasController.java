...
@Controller
@RequestMapping("cuspides")
public class CuspidesCasasController {
	
	private static final String PAGINA = "cuspides";
	private static final String PAGINA_INDEX = "cuspides/index";
	private static final String PAGINA_EDIT = "cuspides/edit";
	private static final String PAGINA_CONSULTAS = "cuspides/index";
	//private static final String PAGINA_REDIRECT = "redirect:/clientes";
	private static final String PAGINA_REDIRECT = "redirect:/cuspides";
	private static final String NOME_CLASSE = "Cuspide";
	
	
	@Autowired
	private MapaCuspideRepository service;
	...
	*/
	...
	public ModelAndView all()
	{
		...
		//List<MapaCuspide> lista = service.findAllOrderBySignoAndCasa();
		List<MapaCuspide> lista = service.findAllOrderBySignoAndCasa();
	...
	*/
	...
	public ModelAndView novo(){
		...
		MapaCuspide model = new MapaCuspide();
		mv.addObject("model", model);
		return mv;
	}
	
	@RequestMapping("/edit/{id}")
	public ModelAndView editar(@PathVariable("id") MapaCuspide model){
		ModelAndView mv = new ModelAndView(PAGINA_EDIT);
		mv.addObject("model", model);
		return mv;
	}
	...
	@PostMapping()
	public String salvar(	@Valid @ModelAttribute("model") MapaCuspide model, 
